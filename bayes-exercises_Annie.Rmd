...
$$  
with A = two of her children are found dead with no evidence of physical harm and B = a mother is a son-murdering psychopath = 0.50. Assume that the rate of son-murdering psychopaths mothers is 1 in 1,000,000.     
According to Bayes' theorem, what is the probability of $\mbox{Pr}(B \mid A)$ ? 

*P(B|A) = P(A|B)xP(B)/P(A) = 0.5x(1/10^6)/(1/8500) = 0.00425*
...
$$
```{r}
sd_postdistribution = sqrt(1/((1/se^2)+(1/tau^2)))
...
```{r}
E_postdistribution + 1.96*sd_postdistribution

c(E_postdistribution - 1.96*sd_postdistribution, E_postdistribution + 1.96*sd_postdistribution)
```
...
```{r}
pnorm(0, E_postdistribution, sd_postdistribution)
